...
RSpec.describe Category, type: :model do
  it 'valid if name is present' do
    @user = User.create!(name: 'rideonone', email: 'rideonone2@gmail.com', password: 1_234_567)
  ...
  it 'invalid if icon is absent' do
    @user = User.create!(name: 'rideonone', email: 'rideonone2@gmail.2com', password: 1_234_567)
